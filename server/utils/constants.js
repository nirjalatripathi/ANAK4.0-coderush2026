...
const DONATION_TRANSITIONS = {
  Pending: ['Payment Verified', 'Rejected', 'Cancelled'],
  'Payment Verified': ['Allocated', 'Cancelled'],
  Pledged: ['Accepted', 'Confirmed', 'Cancelled', 'Rejected'],
  Accepted: ['Dispatched', 'In Transit', 'Cancelled'],
  Confirmed: ['In Transit', 'Dispatched', 'Cancelled'],
  Verified: ['In Transit', 'Allocated', 'Cancelled'],
  Allocated: ['In Use', 'In Transit', 'Cancelled'],
  'In Use': ['Impact Verified', 'Completed'],
  Dispatched: ['Received', 'Partially Received', 'Arrived'],
  'In Transit': ['Arrived', 'Received', 'Partially Received'],
  Arrived: ['Received', 'Partially Received'],
  Received: ['Verified', 'In Inventory', 'Distributed'],
  'Partially Received': ['In Inventory', 'Distributed', 'Disputed'],
  'In Inventory': ['Distributed'],
  Distributed: ['Impact Verified', 'Completed'],
  'Impact Verified': ['Completed'],
  Completed: [],
  Rejected: [],
